  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        dimension: {
          consciousness: "hsl(var(--dimension-consciousness))",
          coherence: "hsl(var(--dimension-coherence))",
          purpose: "hsl(var(--dimension-purpose))",
          compassion: "hsl(var(--dimension-compassion))",
          growth: "hsl(var(--dimension-growth))",
        },
        // Status colors
        success: {
