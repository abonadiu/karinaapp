...
export default function Dashboard() {
  ...
  const statCards = [
    { label: "Empresas", value: stats.companies, icon: Building2, color: "text-primary", href: "/empresas", state: undefined as Record<string, string> | undefined },
    { label: "Participantes", value: stats.participants, icon: Users, color: "text-accent", href: "/participantes", state: undefined as Record<string, string> | undefined },
    { label: "Concluídos", value: stats.completed, icon: BarChart3, color: "text-success", href: "/participantes", state: { statusFilter: "completed" } },
  ];
  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {statCards.map((stat) => (
          <Link key={stat.label} to={stat.href} state={stat.state}>
