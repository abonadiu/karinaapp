      ...
      <header className="border-b border-border/50 bg-background/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#dimensoes" className="text-muted-foreground hover:text-foreground transition-colors">
              Dimensões
            </a>
            <a href="#facilitadores" className="text-muted-foreground hover:text-foreground transition-colors">
              Para Facilitadores
            </a>
          </nav>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 animate-fade-in text-balance" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-warm bg-card">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="font-display text-xl font-semibold mb-2">Diagnóstico Profundo</h3>
            ...
            <Card className="border-0 shadow-warm bg-card">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="font-display text-xl font-semibold mb-2">Exercícios Vivenciais</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="border-0 shadow-warm bg-card">
              <CardContent className="p-8 text-center">
                <div className="w-14 h-14 rounded-2xl bg-dimension-purpose/10 flex items-center justify-center mx-auto mb-4">
                  <TrendingUp className="w-7 h-7 text-dimension-purpose" />
                </div>
                <h3 className="font-display text-xl font-semibold mb-2">Plano Personalizado</h3>
                <p className="text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-sm text-muted-foreground">
              © 2025 Plataforma IQ+IS. Todos os direitos reservados.
            </p>
